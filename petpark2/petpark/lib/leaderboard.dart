              ...
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      WinnerContainer(
                        height: 120, winnerName: 'Hermione', rank:'2', experience: '1340', color: Colors.blue[400],
                      ),
                      WinnerContainer(
                        isFirst: true, winnerName: 'Christiano',experience:'1500', rank:'1', color: Colors.redAccent[700],
                      ),
                      WinnerContainer(
                        height: 120, winnerName: 'Wednesday', experience: '900', rank:'2', color: Colors.green[600],
                      ),
                    ],
                  ),
                ),
...
class WinnerContainer extends StatelessWidget{
  ...
  final double? height;
  const WinnerContainer({Key ?key, this.isFirst=false, this.color, this.winnerposition,  this.winnerName, this.rank, this.experience, this.height}) : super(key: key);
  @override
  Widget build(BuildContext context){
    return Padding(
      padding: const EdgeInsets.all(10.0),
        ...
        children: [
                ...
                Padding(
                  ...
                  child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        child: Center(child: Text(rank??'1', style: TextStyle(color:Colors.red[400]))),
                      ),
                ),
                  ],
            ),
          ...
          Padding(
            ...
            child: Center(
              child: Column(
                children: [
                  Text(winnerName??'Tracey', style: TextStyle(color: Colors.white, fontSize: 16.0, fontWeight: FontWeight.bold)),
                  Text(experience??'234', style: TextStyle(color: color??Colors.white, fontSize: 16.0, fontWeight: FontWeight.bold)) 
                ],
              ),
            ),
          )
